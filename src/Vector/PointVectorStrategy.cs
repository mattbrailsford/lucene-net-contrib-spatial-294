...
namespace Lucene.Net.Spatial.Vector
{
	...
	public class PointVectorStrategy : SpatialStrategy
	{
        ...
        private Query MakeWithin(Rectangle bbox)
	    {
	        ...
	        {
	            bq.Add(RangeQuery(fieldNameX, bbox.GetMinX(), bbox.GetMaxX()), BooleanClause.Occur.MUST);
	        }
	        bq.Add(RangeQuery(fieldNameY, bbox.GetMinY(), bbox.GetMaxY()), BooleanClause.Occur.MUST);
	        return bq;
	    }
